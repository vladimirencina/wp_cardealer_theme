	...
	?>
		...
		<div class="row padding-bottom-40">
			...
			<div class="col-md-12">
				...
				<?php if (!empty($user_data->last_name)) { ?>
					...
					<h3 class="section-title"><?php esc_html_e( 'Contact Person', 'cardealer' ); ?>
			...
			<div class="col-md-6">
				...
				<ul class="contact-items">
					...
					<?php if ( ! empty( $user_data->phone ) ): ?>
						<li><b><?php esc_html_e( 'Phone', 'cardealer' ); ?>
								:</b>&nbsp;<span><?php echo $user_data->phone ?></span></li>
					<?php endif; ?>
					<?php if ( ! empty( $user_data->mobile ) ): ?>
						<li><b><?php esc_html_e( 'Mobile', 'cardealer' ); ?>
								:</b>&nbsp;<span><?php echo $user_data->mobile ?></span></li>
					<?php endif; ?>
					<?php if ( ! empty( $user_data->fax ) ): ?>
						<li><b><?php esc_html_e( 'Fax', 'cardealer' ); ?>:</b>&nbsp;<span><?php echo $user_data->fax ?></span>
						</li>
					<?php endif; ?>
					<?php if ( ! empty( $user_data->address ) ): ?>
						<li><b><?php esc_html_e( 'Address', 'cardealer' ); ?>
		...
		<div class="row padding-bottom-40">
			...
			<div class="col-md-12">
				...
				<?php if ( $map_data['show_map_to_visitors'] ){ ?>
					...
					<h3 class="section-title"><?php esc_html_e( 'Location on Map', 'cardealer' ); ?></h3>
		...
		<div class="row padding-bottom-40">
			...
			<div class="col-md-12">
				...
				<h3 class="section-title"><?php esc_html_e( 'Latest dealers cars', 'cardealer' ); ?></h3>
