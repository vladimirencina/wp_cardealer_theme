    ...
    <div class="container">
		...
		<div class="row">
			<div class="col-xs-12 adjective">
				<p class="alignleft"><?php esc_html_e('Copyright ', 'cardealer'); ?> &copy; <?php auto_copyright("2015"); ?>. <?php echo esc_html(TMM::get_option("copyright_text")) ?></p>
				<p class="alignright"><?php esc_html_e('Developed by', 'cardealer'); ?>
