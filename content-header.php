...
if (!is_front_page() && !TMM_Helper::is_front_lang_page()) {
	...
	if (is_single() || is_page() || is_home()) {
		...
		$title = sprintf( esc_html__('Search Results for: %s', 'cardealer'), '<span>' . get_search_query() . '</span>');
	}
