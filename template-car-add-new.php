		...
		<script type="text/javascript">
			...
			jQuery(function() {
				if (locations_max_level >= 2) {
					...
					jQuery(document.body).on('change', '#tax_carlocation1', function() {
				...
				jQuery(document.body).on('change', '#tax_carproducer', function() {
			...
			function draw_locations_select(parent_id, id) {
				...
				if (parent_id !== '') {
					select_cont.html("<?php esc_html_e('Wait a moment ...', 'cardealer'); ?>");
					var data = {
					...
					<div class="cart-holder clearfix">
						...
						<ul class="cart-items clearfix">
							...
							<li class="cart-title" id="head_step4">
								<h5 class="cart-title"><?php esc_html_e('Submit', 'cardealer'); ?></h5>
						...
						<div class="cart-content step-1 thememakers_car_app_new_car_block" id="thememakers_car_app_new_car_1">
							...
							<div class="row">
								<div class="col-md-4">
									...
									<p>
										<label for="car_state">
											<strong><?php esc_html_e('Estado del vehículo', 'cardealer'); ?></strong>
										</label>
										<select <?php
									...
									<p>
										...
										<label for="tax_carproducer"><strong><?php esc_html_e('Car Make', 'cardealer'); ?></strong></label>
									...
									<p>
										<label for="tax_carproducer2"><strong><?php esc_html_e('Car Model', 'cardealer'); ?></strong></label>
									...
									<!-- Car Body -->
									<p>
										<label for="car_body"><strong><?php esc_html_e('Car Body', 'cardealer'); ?></strong></label>
								...
								<div class="col-md-4">
									...
									<div class="row">
										<div class="col-xs-8 col-sm-6">
											...
											<p>
												<label
													for="car_interrior_color"><strong><?php esc_html_e('Car Interior Color', 'cardealer'); ?></strong></label>
												<select <?php
										...
										<div class="col-xs-4 col-sm-6">
											...
											<p>
												<label
													for="car_exterior_color"><strong><?php esc_html_e('Car Exterior Color', 'cardealer'); ?></strong></label>
												<select <?php
									...
									<div class="row">
										<div class="col-xs-8 col-sm-6">
											...
											<!-- Gear Box -->
											<p>
												<label for="car_transmission"><strong><?php esc_html_e('Car Gearbox', 'cardealer'); ?></strong></label>
										...
										<div class="col-xs-4 col-sm-6">
											...
											<!-- Door Count -->
											<p>
												<label for="car_doors_count"><strong><?php esc_html_e('Car Door Count', 'cardealer'); ?></strong></label>
												<select <?php
								...
								<div class="col-md-4">
									...
									<div class="row">
										<div class="col-xs-8 col-sm-6">
											...
											<!-- Car VIN -->
											<p>
												<label for="car_vin"><strong><?php esc_html_e('Car VIN', 'cardealer'); ?></strong></label>
												<input <?php
							...
							<?php } ?>
								...
								<!-- Car Description -->
								<p>
									<label for="car_adv_desc"><strong><?php esc_html_e('Car Description', 'cardealer'); ?></strong> (<?php esc_html_e("signs left", 'cardealer'); ?> <span id="car_adv_desc_signs_left"><?php echo $max_desc_count; ?></span>)</label>
									<textarea <?php
