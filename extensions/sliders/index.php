...
class TMM_Ext_Sliders {
	...
	public static function register() {
		self::$easing_effects = array(
			'swing' => esc_html__('Swing', 'cardealer'),
			'easeInQuad' => esc_html__('easeInQuad', 'cardealer'),
			'easeOutQuad' => esc_html__('easeOutQuad', 'cardealer'),
			'easeInOutQuad' => esc_html__('easeInOutQuad', 'cardealer'),
			'easeInCubic' => esc_html__('easeInCubic', 'cardealer'),
			'easeOutCubic' => esc_html__('easeOutCubic', 'cardealer'),
			'easeInOutCubic' => esc_html__('easeInOutCubic', 'cardealer'),
			'easeInQuart' => esc_html__('easeInQuart', 'cardealer'),
			'easeOutQuart' => esc_html__('easeOutQuart', 'cardealer'),
			'easeInOutQuart' => esc_html__('easeInOutQuart', 'cardealer'),
			'easeInQuint' => esc_html__('easeInQuint', 'cardealer'),
			'easeOutQuint' => esc_html__('easeOutQuint', 'cardealer'),
			'easeInOutQuint' => esc_html__('easeInOutQuint', 'cardealer'),
			'easeInExpo' => esc_html__('easeInExpo', 'cardealer'),
			'easeOutExpo' => esc_html__('easeOutExpo', 'cardealer'),
			'easeInOutExpo' => esc_html__('easeInOutExpo', 'cardealer'),
			'easeInSine' => esc_html__('easeInSine', 'cardealer'),
			'easeOutSine' => esc_html__('easeOutSine', 'cardealer'),
			'easeInOutSine' => esc_html__('easeInOutSine', 'cardealer'),
			'easeInCirc' => esc_html__('easeInCirc', 'cardealer'),
			'easeOutCirc' => esc_html__('easeOutCirc', 'cardealer'),
			'easeInOutCirc' => esc_html__('easeInOutCirc', 'cardealer'),
			'easeInElastic' => esc_html__('easeInElastic', 'cardealer'),
			'easeOutElastic' => esc_html__('easeOutElastic', 'cardealer'),
			'easeInOutElastic' => esc_html__('easeInOutElastic', 'cardealer'),
			'easeInBack' => esc_html__('easeInBack', 'cardealer'),
			'easeOutBack' => esc_html__('easeOutBack', 'cardealer'),
			'easeInOutBack' => esc_html__('easeInOutBack', 'cardealer'),
			'easeInBounce' => esc_html__('easeInBounce', 'cardealer'),
			'easeOutBounce' => esc_html__('easeOutBounce', 'cardealer'),
			'easeInOutBounce' => esc_html__('easeInOutBounce', 'cardealer'),
		);
	...
	public static function init_meta_boxes() {
		add_meta_box("tmm_slides_meta", esc_html__("Slides", 'cardealer'), array(__CLASS__, 'draw_slidergroup_slides_meta'), self::$slug, "normal", "low");
		//***
		add_meta_box("tmm_slider_meta_box", esc_html__("Page slider", 'cardealer'), array(__CLASS__, 'draw_page_slides_meta_box'), "post", "side", "low");
		add_meta_box("tmm_slider_meta_box", esc_html__("Page slider", 'cardealer'), array(__CLASS__, 'draw_page_slides_meta_box'), "page", "side", "low");
	}

	public static function get_slider_types() {
		$result = array(
			0 => esc_html__('No slider', 'cardealer'),
		);
	...
	public static function show_edit_columns($columns) {
		$columns = array(
			...
			"image" => esc_html__("Group Cover", 'cardealer'),
			"count" => esc_html__("Image Count", 'cardealer'),
		);
