var TMM_APP_CARDEALER_ADMIN_USERMANAGER = function () {
	var self = {
		init: function () {
			...
			jQuery(".add_user_role").click(function () {
				...
				if (user_role_name.length > 0) {
					...
					jQuery.post(ajaxurl, data, function (response) {
						...
						//***
						jQuery(".custom_user_roles_list").append('<li><a data-id="user_role_' + response.user_role_id + '" data-id-num="' + response.user_role_id + '" class="js_edit_user_role js_user_role_text" href="#">' + user_role_name + '</a><input type="hidden" name="user_roles[' + response.user_role_id + '][name]" value="' + user_role_name + '" /><a href="#" title="' + tmm_l10n.lang_delete + '" class="remove js_remove_user_role" data-id="user_role' + response.user_role_id + '"></a><a data-id="user_role_' + response.user_role_id + '" href="#" title="' + tmm_l10n.lang_edit + '" class="edit js_edit_user_role"></a></li>');
						jQuery(".custom_user_roles_list").sortable();
			...
			jQuery(document.body).on('click', '.js_edit_user_role', function () {
			...
			jQuery(document.body).on('click', '.js_back_to_user_roles_list', function () {
			...
			jQuery(document.body).on('click', ".js_remove_user_role", function () {
			...
			jQuery(document.body).on('keyup', '.user_role_name_input', function () {
				var id = jQuery(this).data('id');
...
var TMM_APP_CARDEALER_ADMIN_FEATURESPACKMANAGER = function () {
	var self = {
		init: function () {
			...
			jQuery(".add_features_packet").click(function () {
				...
				if (name.length > 0) {
					...
					jQuery.post(ajaxurl, data, function (response) {
						...
						jQuery("#user_role_name").val("");
						//***
						jQuery(".features_packets_list").append('<li><a data-id="features_packet_' + response.packet_id + '" class="js_edit_features_packet js_features_packet_text" href="#">' + name + '</a><input type="hidden" name="features_packets[' + response.packet_id + '][name]" value="' + name + '" /><a href="#" title="' + tmm_l10n.lang_delete + '" class="remove js_remove_features_packet" data-id="features_packet_' + response.packet_id + '"></a><a data-id="features_packet_' + response.packet_id + '" href="#" title="' + tmm_l10n.lang_edit + '" class="edit js_edit_features_packet"></a></li>');
						jQuery(".features_packets_list").sortable();
			...
			jQuery(document.body).on('click', '.js_edit_features_packet', function () {
				var id = jQuery(this).data('id');
			...
			jQuery(document.body).on('click', ".js_remove_features_packet", function () {
			...
			jQuery(document.body).on('keyup', '.features_packet_name_input', function () {
				var id = jQuery(this).data('id');
