...
?>
			...
			if (locations_max_level >= 2) {
				...
				car_location_select.live('change', function () {
					draw_locations_select(jQuery(this).val(), 2);
				});
			}

			if (locations_max_level >= 3) {
				jQuery('#tax_carlocation2').live('change', function () {
			...
			car_desc.live('keydown input paste', function () {
			...
			jQuery('#save_edited_car').live('submit', function () {
				return save_edited_car();
			});

			jQuery('#car_state').live('change', function(){
			...
			function save_edited_car() {
				...
				if (is_required) {
					show_info_popup('Please fill all required fields!');
					return false;
				}
				return true;
			}
	...
	<div class="ad edit-form">
		...
		<div class="edit-form__title">
			<h3><?php esc_html_e('Edit Videos', 'cardealer'); ?></h3>
			...
			<div class="row">
				<div class="col-md-6">
					...
					<label for="car_videos">
						<strong><?php esc_html_e('Videos', 'cardealer'); ?></strong>
					</label>
	...
	<div class="ad edit-form">
		<div class="edit-form__title">
			<h3><?php esc_html_e('Edit Vehicle Make, Model, Technical Data, Location and Description', 'cardealer'); ?></h3>
		</div><!-- .edit-form__title -->
							...
							<p>
								...
								<input <?php if ( $required_car_features['car_engine_additional'] == '1' ) {
									echo " data-required=1";
								     ...
								     name="car_engine_additional" placeholder="<?php esc_html_e('eg: TDi, TSi, Li ...', 'cardealer'); ?>">
	...
	<div class="ad edit-form">
		...
		<div class="edit-form__title">
			<h3><?php esc_html_e('Feature Sets', 'cardealer'); ?></h3>
		</div><!-- .edit-form__title -->
