...
<p>
	...
	<label for="<?php echo $widget->get_field_id('show_links'); ?>"><?php esc_html_e('Display Links', 'cardealer') ?></label>
</p>
<p>
	...
	<label for="<?php echo $widget->get_field_id('show_quick_statistic'); ?>"><?php esc_html_e('Display Quick Statistic', 'cardealer') ?></label>
</p>
<p>
	...
	<label for="<?php echo $widget->get_field_id('show_dealer_status'); ?>"><?php esc_html_e('Display Dealer Status', 'cardealer') ?></label>
</p>
<p>
	...
	<label for="<?php echo $widget->get_field_id('show_loan_rate'); ?>"><?php esc_html_e('Display Loan Rate Field', 'cardealer') ?></label>
</p>