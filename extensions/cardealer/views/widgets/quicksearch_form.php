...
<p>
    ...
    <label for="<?php echo $widget->get_field_id('show_search_state_cars'); ?>"><?php esc_html_e('Car Condition', 'cardealer') ?></label>
</p>
<p>
	<?php
	$checked = "";
    ...
    <label for="<?php echo $widget->get_field_id('show_producers_and_models'); ?>"><?php esc_html_e('Producers &amp; Models', 'cardealer') ?></label>
</p>
<p>
	<?php
	$checked = "";
    ...
    <label for="<?php echo $widget->get_field_id('show_min_max_price'); ?>"><?php esc_html_e('Price Range', 'cardealer') ?></label>
</p>
<p>
	<?php
	$checked = "";
    ...
    <label for="<?php echo $widget->get_field_id('show_years'); ?>"><?php esc_html_e('Year Range', 'cardealer') ?></label>
</p>
<p>
	<?php
	$checked = "";
    ...
    <label for="<?php echo $widget->get_field_id('show_mileage'); ?>"><?php ($mileage_unit == 'km') ? esc_html_e('Kilometer', 'cardealer') : esc_html_e('Mileage', 'cardealer') ?></label>
</p>
<p>
	<?php
	$checked = "";
    ...
    <label for="<?php echo $widget->get_field_id('show_fuel_type'); ?>"><?php esc_html_e('Fuel type', 'cardealer') ?></label>
</p>
<p>
	<?php
	$checked = "";
    ...
    <label for="<?php echo $widget->get_field_id('show_transmission'); ?>"><?php esc_html_e('Gearbox', 'cardealer') ?></label>
</p>
...
<p>
    ...
    <label for="<?php echo $widget->get_field_id('show_body_type'); ?>"><?php esc_html_e('Body type', 'cardealer') ?></label>
</p>
...
<p>
    ...
    <label for="<?php echo $widget->get_field_id('show_doors_count'); ?>"><?php esc_html_e('Doors count', 'cardealer') ?></label>
</p>
...
<p>
    ...
    <label for="<?php echo $widget->get_field_id('show_colors'); ?>"><?php esc_html_e('Colors', 'cardealer') ?></label>
</p>
<p>
	<?php
	$checked = "";
    ...
    <label for="<?php echo $widget->get_field_id('show_advanced_options'); ?>"><?php esc_html_e('Advanced Search', 'cardealer') ?></label>
</p>
