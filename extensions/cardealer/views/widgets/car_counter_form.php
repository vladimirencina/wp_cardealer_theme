...
<p>
	...
	<label for="<?php echo $widget->get_field_id('show_last_hour_cell'); ?>"><?php esc_html_e('Display "Last Hour" cell', 'cardealer') ?></label>
</p>
<p>
	<?php
	$checked = "";
	...
	<label for="<?php echo $widget->get_field_id('show_last_day_cell'); ?>"><?php esc_html_e('Display "Last Day" cell', 'cardealer') ?></label>
</p>
<p>
	<?php
	$checked = "";
	...
	<label for="<?php echo $widget->get_field_id('show_cars_total_cell'); ?>"><?php esc_html_e('Display "Added cars total" cell', 'cardealer') ?></label>
</p>