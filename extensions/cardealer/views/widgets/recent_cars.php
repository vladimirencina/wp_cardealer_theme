...
<div class="widget widget_latest">
    ...
    <ul class="clearfix">
		...
		<?php if ($query->have_posts()) : while ($query->have_posts()) : $query->the_post(); ?>
				...
				?>
				<li>
					<a href="<?php the_permalink(); ?>" class="thumb single-image<?php echo esc_attr( $icon_class ) ?>">
					...
					<div class="table-entry">
						...
						<p class="specs">
							...
							if(!empty($car_data['car_engine_size'])){
								echo esc_attr( $car_data['car_engine_size'] ) . ' ' . tmm_get_car_engine_unit();
							}
							if(!empty($car_data['car_mileage'])){
								echo ', ' . esc_attr( $car_data['car_mileage'] ) . ' ' . tmm_get_car_mileage_unit();
							}
							?>
						</p>
	...
	?>
		<a class="button orange" href="<?php echo esc_url( $searching_page ) ?>"><?php esc_html_e('All Cars', 'cardealer'); ?></a><br />
	<?php endif; ?>
