...
<p>
	...
	<label for="<?php echo $widget->get_field_id('show_dealers_name'); ?>"><?php esc_html_e('Show dealers name', 'cardealer') ?></label>
</p>
...
<p>
	...
	<label
		for="<?php echo $widget->get_field_id('show_contact_person'); ?>"><?php esc_html_e('Show contact person', 'cardealer') ?></label>
</p>
...
<p>
	...
	<label for="<?php echo $widget->get_field_id('show_address'); ?>"><?php esc_html_e('Show address', 'cardealer') ?></label>
</p>
...
<p>
	...
	<label for="<?php echo $widget->get_field_id('show_phone'); ?>"><?php esc_html_e('Show phone', 'cardealer') ?></label>
</p>
...
<p>
	...
	<label for="<?php echo $widget->get_field_id('show_mobile'); ?>"><?php esc_html_e('Show mobile', 'cardealer') ?></label>
</p>
...
<p>
	...
	<label for="<?php echo $widget->get_field_id('show_fax'); ?>"><?php esc_html_e('Show fax', 'cardealer') ?></label>
</p>
...
<p>
	...
	<label for="<?php echo $widget->get_field_id('show_email'); ?>"><?php esc_html_e('Show email', 'cardealer') ?></label>
</p>
...
<p>
	...
	<label for="<?php echo $widget->get_field_id('show_skype'); ?>"><?php esc_html_e('Show skype', 'cardealer') ?></label>
</p>
...
<p>
	...
	<label for="<?php echo $widget->get_field_id('show_url'); ?>"><?php esc_html_e('Show url', 'cardealer') ?></label>
</p>