...
if ($wp_query->query_vars['posts_per_page'] < $wp_query->found_posts){
    ...
    <div class="wp-pagenavi">
        ...
        if(isset($show_total_items) && $show_total_items == true){
            ...
            <div class="total-items">
                    <?php echo (int) $wp_query->found_posts . ' ' .  esc_html__('items', 'cardealer'); ?>
            </div><!--/ .total-items-->
            <div class="clear"></div>
	...
	if(isset($show_total_items) && $show_total_items == true && $wp_query->found_posts > 0){
	    ...
	    <div class="wp-pagenavi">
            <div class="total-items">
                    <?php echo (int) $wp_query->found_posts . ' ' . ( $wp_query->found_posts > 1 ? esc_html__('items', 'cardealer') : esc_html__('item', 'cardealer') ); ?>
            </div><!--/ .total-items-->
            <div class="clear"></div>
	    </div><!--/ .wp-pagenavi -->
	    <?php
