...
<aside class="col-md-3 padding-top-40">
    ...
    <div class="widget widget_statistic">
        ...
        <h3 class="widget-title"><?php echo esc_html( $user_info->display_name ) ?> <?php esc_html_e('Cars', 'cardealer'); ?></h3>
            
        <section class="clearfix">
            <input type="hidden" id="current_user_id" data-id="<?php echo esc_attr( $user_id ) ?>" data-posts-per-page="6" data-template="<?php if (!empty($_POST['template_user_dealer']) && ($_POST['template_user_dealer'] == true)) { echo 'template_user_dealer'; } ?>">
            <ul>
                <li>
