jQuery(document).ready(function() {
	...
	jQuery('.js_add_form').click(function() {
		...
		//*****
		jQuery(".contact_forms_groups_list").append('<li><a data-id="contact_form_' + index + '" class="js_edit_contact_form" href="#">' + new_contact_form_name + '</a><a href="#" title="' + tmm_l10n.lang_delete + '" class="remove delete_contact_form" data-id="contact_form_' + index + '"></a><a data-id="contact_form_' + index + '" href="#" title="' + tmm_l10n.lang_edit + '" class="edit js_edit_contact_form"></a></li>');
