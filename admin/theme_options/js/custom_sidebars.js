	...
	jQuery(".add_sidebar").click(function() {
		...
		if (sidebar_name.length > 0) {
			...
			jQuery.post(ajaxurl, data, function(response) {
				...
				//***
				jQuery(".custom_sidebars_list").append('<li><a data-id="sidebar_' + sidebar_id + '" class="js_edit_sidebar" href="#">' + sidebar_name + '</a><input type="hidden" name="sidebars[' + sidebar_id + '][name]" value="' + sidebar_name + '" /><a href="#" title="' + tmm_l10n.lang_delete + '" class="remove js_remove_sidebar" data-id="sidebar_' + sidebar_id + '"></a><a data-id="sidebar_' + sidebar_id + '" href="#" title="' + tmm_l10n.lang_edit + '" class="edit js_edit_sidebar"></a></li>');
				jQuery(".custom_sidebars_list").sortable();
			});
		}
