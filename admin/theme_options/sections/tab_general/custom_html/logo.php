...
<div class="option option-radio">
	...
	<div class="controls">
		...
		<label for="logotext"><span></span><?php esc_html_e('Text', 'cardealer'); ?></label>
		...
		<label for="logoimage"><span></span><?php esc_html_e('Image', 'cardealer'); ?></label>&nbsp; &nbsp;
	</div><!--/ .controls-->
...
<ul class="show-hide-items">
	...
	<li class="logo_img" <?php echo (TMM::get_option('logo_type') ? "" : 'style="display:none;"') ?>>
		...
		TMM_OptionsHelper::draw_theme_option(array(
			...
			'type' => 'upload',
			'default_value' => '',
			'description' => esc_html__('Upload your logo image here. Recommended dimensions: width <= 300px, height = any. Recommended image types: png, gif, jpg.', 'cardealer'),
			'id' => '',
		));
		?>
	...
	<li class="logo_text" <?php echo(!TMM::get_option('logo_type') ? "" : 'style="display:none;"') ?>>
		...
		TMM_OptionsHelper::draw_theme_option(array(
			...
			'type' => 'text',
			'description' => esc_html__('Type your website name here, it will appear instead of your Logo in text format.', 'cardealer'),
			'default_value' => esc_html__('cardealer', 'cardealer'),
			'css_class' => '',
		));
		?>
		...
		TMM_OptionsHelper::draw_theme_option(array(
			'name' => 'logo_font_size',
			'type' => 'select',
			'title'=> esc_html__('Logo Font Size', 'cardealer'),
			'description' => '',
		...
		TMM_OptionsHelper::draw_theme_option(array(
			'name' => 'logo_font',
			'title' => esc_html__('Logo Font Family', 'cardealer'),
		...
		TMM_OptionsHelper::draw_theme_option(array(
			...
			'description' => esc_html__('Can be applied for text logo only. Can not be used on One-Page page types', 'cardealer'),
			'css_class' => '',
			'is_reset' => true
		));
		?>
