...
<a href="#" class="admin-button button-gray js_back_to_sidebars_list"><?php esc_html_e('Back to sidebars list', 'cardealer'); ?></a>
...
<div class="option">
	...
	<div class="admin-one-half">
		...
		<div class="add-button add_page" data-id="<?php echo $sidebar_id ?>"></div>&nbsp;<strong><?php esc_html_e('Add Page', 'cardealer'); ?></strong>
	...
	<div class="admin-one-half last">
		...
		<div class="add-button add_category" data-id="<?php echo $sidebar_id ?>"></div>&nbsp;<strong><?php esc_html_e('Add Category', 'cardealer'); ?></strong>
