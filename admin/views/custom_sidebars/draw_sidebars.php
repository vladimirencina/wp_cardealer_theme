			...
			<div id="<?php echo $sidebar_id; ?>" class="tab-content" style="display: none">
				<div class="clearfix ">
					...
					<div class="admin-one-half">
						...
						<div class="add-button add_page" sidebar-id="<?php echo $sidebar_id ?>"></div>&nbsp;<strong><?php esc_html_e('Add Page', 'cardealer'); ?></strong>
					...
					<div class="admin-one-half last">
						...
						<div class="add-button add_category" sidebar-id="<?php echo $sidebar_id ?>"></div>&nbsp;<strong><?php esc_html_e('Add Category', 'cardealer'); ?></strong>
						<?php
