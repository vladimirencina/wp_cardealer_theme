...
<table class="form-table">
    <tbody>
        <tr>
            <th style="width:25%">
                <label for="staff_email">
                    <strong><?php esc_html_e('Email', 'cardealer'); ?></strong>
        ...
        <tr>
            <th style="width:25%">
                <label for="office_phone">
                    <strong><?php esc_html_e('Office phone', 'cardealer'); ?></strong>
                    <span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;"></span>
                </label>
            </th>
            <td>
        ...
        <tr>
            <th style="width:25%">
                <label for="mobile_phone">
                    <strong><?php esc_html_e('Mobile phone', 'cardealer'); ?></strong>
                    <span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;"></span>
                </label>
            </th>
            <td>
        ...
        <tr>
            <th style="width:25%">
                <label for="fax">
                    <strong><?php esc_html_e('Fax', 'cardealer'); ?></strong>
                    <span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;"></span>
                </label>
            </th>
            <td>
        ...
        <tr>
	        <th style="width:25%">
		        <label for="facebook">
			        <strong><?php esc_html_e('Facebook', 'cardealer'); ?></strong>
			        <span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;"></span>
		        </label>
	        </th>
	        <td>
        ...
        <tr>
	        <th style="width:25%">
		        <label for="twitter">
			        <strong><?php esc_html_e('Twitter', 'cardealer'); ?></strong>
			        <span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;"></span>
		        </label>
	        </th>
	        <td>
        ...
        <tr>
	        <th style="width:25%">
		        <label for="gplus">
			        <strong><?php esc_html_e('Google+', 'cardealer'); ?></strong>
			        <span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;"></span>
		        </label>
	        </th>
	        <td>
        ...
        <tr>
	        <th style="width:25%">
		        <label for="desc">
			        <strong><?php esc_html_e('Description', 'cardealer'); ?></strong>
			        <span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;"></span>
		        </label>
	        </th>
	        <td>
