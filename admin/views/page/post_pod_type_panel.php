							...
							<th style="width:25%">
								<label for="post_type_conrainer">
									...
									<span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;">
										<?php esc_html_e('Set up a video for this post', 'cardealer'); ?>
									</span>
								</label>
							</th>
							<td>
								...
								&nbsp;
								<a class="button button_upload_video" href="#" style="float: left; margin-left: 9px;"><?php esc_html_e('Browse', 'cardealer'); ?></a>
							</td>
						</tr>
						<tr>
							<th style="width:25%">
							...
							<td>
								...
								<label class="selectit">
									...
									<?php esc_html_e('Show Cover Image Only on Mobiles', 'cardealer'); ?>
								</label>
							</td>
						</tr>
					</table>
						...
						<tr>
							<th style="width:25%">
								<label for="post_type_conrainer">
									<strong><?php echo $post_type_name ?></strong>
									<span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;">
										<?php esc_html_e('Set up an audio for this post', 'cardealer'); ?>
									</span>
								</label>
							</th>
							<td>
								...
								&nbsp;<a class="button button_upload_audio" href="#" style="float: left; margin-left: 9px;"><?php esc_html_e('Browse', 'cardealer'); ?></a>
							</td>
						</tr>
					</table>
					<?php
						...
						<tr>
							<th style="width:25%">
								<label for="post_type_conrainer">
									<strong><?php echo $post_type_name ?></strong>
									<span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;">
										<?php esc_html_e('Place here a link for this post like http://site.com/', 'cardealer'); ?>
									</span>
								</label>
							</th>
							<td>
						...
						<tr>
							<th style="width:25%">
								<label for="post_type_conrainer">
									<strong><?php echo $post_type_name ?></strong>
									<span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;">
										<?php esc_html_e('Create a quote for this post', 'cardealer'); ?>
									</span>
								</label>
							</th>
							<td>
						...
						<tr>
							<th style="width:25%">
								<label for="post_type_conrainer">
									<strong><?php echo $post_type_name ?></strong>
									<span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;">
										<?php esc_html_e('Create your gallery for post', 'cardealer'); ?>
									</span>
								</label>
								<p><a href="#" style="float:left;" class="add-images-to-page button"><?php esc_html_e('Add Images', 'cardealer'); ?></a></p>
							</th>
							<td>
...
<script type="text/javascript">
	...
	function add_meta_slide_items(img_urls, index) {
		show_info_popup('<?php esc_html_e('Wait a moment ...', 'cardealer'); ?>');
		var data = {
