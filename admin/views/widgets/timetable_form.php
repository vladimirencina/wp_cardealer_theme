...
<div class="entry-content">
	...
	<p>
		<label for="<?php echo $widget->get_field_id('mon_start'); ?>"><?php esc_html_e('Monday', 'cardealer') ?>:</label>
		...
		<label for="<?php echo $widget->get_field_id('mon_is_closed'); ?>"><?php esc_html_e('Closed', 'cardealer') ?></label>
	...
	<p>
		<label for="<?php echo $widget->get_field_id('tue_start'); ?>"><?php esc_html_e('Tuesday', 'cardealer') ?>:</label>
		...
		<label for="<?php echo $widget->get_field_id('tue_is_closed'); ?>"><?php esc_html_e('Closed', 'cardealer') ?></label>
	...
	<p>
		<label for="<?php echo $widget->get_field_id('wed_start'); ?>"><?php esc_html_e('Wednesday', 'cardealer') ?>:</label>
		...
		<label for="<?php echo $widget->get_field_id('wed_is_closed'); ?>"><?php esc_html_e('Closed', 'cardealer') ?></label>
	...
	<p>
		<label for="<?php echo $widget->get_field_id('thu_start'); ?>"><?php esc_html_e('Thursday', 'cardealer') ?>:</label>
		...
		<label for="<?php echo $widget->get_field_id('thu_is_closed'); ?>"><?php esc_html_e('Closed', 'cardealer') ?></label>
	...
	<p>
		<label for="<?php echo $widget->get_field_id('fri_start'); ?>"><?php esc_html_e('Friday', 'cardealer') ?>:</label>
		...
		<label for="<?php echo $widget->get_field_id('fri_is_closed'); ?>"><?php esc_html_e('Closed', 'cardealer') ?></label>
	...
	<p>
		<label for="<?php echo $widget->get_field_id('sat_start'); ?>"><?php esc_html_e('Saturday', 'cardealer') ?>:</label>
		...
		<label for="<?php echo $widget->get_field_id('sat_is_closed'); ?>"><?php esc_html_e('Closed', 'cardealer') ?></label>
	...
	<p>
		<label for="<?php echo $widget->get_field_id('sun_start'); ?>"><?php esc_html_e('Sunday', 'cardealer') ?>:</label>
		...
		<label for="<?php echo $widget->get_field_id('sun_is_closed'); ?>"><?php esc_html_e('Closed', 'cardealer') ?></label>
