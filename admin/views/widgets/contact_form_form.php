...
<p>
    <label for="<?php echo $widget->get_field_id('form'); ?>"><?php esc_html_e('Form', 'cardealer') ?>:</label>
...
<p>
	<small><?php esc_html_e("You can create a contact form from Theme Options->Contact Forms", 'cardealer') ?></small>
</p>
