...
<p>
    <label for="<?php echo $widget->get_field_id('twitter'); ?>"><?php esc_html_e('Twitter', 'cardealer') ?>:</label>
...
<p>
    <label for="<?php echo $widget->get_field_id('facebook'); ?>"><?php esc_html_e('Facebook', 'cardealer') ?>:</label>
